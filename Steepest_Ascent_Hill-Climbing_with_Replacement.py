# Implementation of Steepest Ascent Hill-Climbing with Replacement
import random
import math
...
def steepest_ascent_hill_climbing_with_replacement():
    solution = random.uniform(X_MIN, X_MAX) # some initial candidate solution
    bestSolution = solution # initial best solution
    ...
    print "Steepest Ascent Hill-Climbing with Replacement: " +\
            str((round(bestSolution, 3), round(f(bestSolution), 3)))

# execute
steepest_ascent_hill_climbing_with_replacement()
